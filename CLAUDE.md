...
- Docs-site JavaScript ESM on Node, with Markdown/MDX content under `docs-site/src/content/docs/` + Astro 6.4.6, Starlight 0.40.0, existing `starlight-links-validator` (008-troubleshooting-security-trust-update-rollback)
- Checked-in Markdown/MDX files only; no database, browser storage, or runtime state (008-troubleshooting-security-trust-update-rollback)
