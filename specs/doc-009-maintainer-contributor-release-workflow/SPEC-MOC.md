...
# Consumed by speckit-scaffold-spec via token substitution, same mechanism as
# workflow-template.md. Tokens have been substituted for this DOC-009 marker.
#
...
- [checklists/ci-validation.md](checklists/ci-validation.md)
- [checklists/documentation-ia.md](checklists/documentation-ia.md)
