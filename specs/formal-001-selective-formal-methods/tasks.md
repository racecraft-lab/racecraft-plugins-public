...
- [ ] T5a qualify Python, TypeScript, and Swift trace emitters against the same model, including legal-state/illegal-transition defects
- [ ] T6b qualify language tooling and CI profiles; record unexecuted profiles explicitly
- [ ] T5b research and qualify Quint's optional Apalache modeling path and ITF trace integration; preserve explicit installation and selection
