...
- [contracts/car-003-additive-records.schema.json](contracts/car-003-additive-records.schema.json)
- [contracts/experiment-assignment.schema.json](contracts/experiment-assignment.schema.json)
