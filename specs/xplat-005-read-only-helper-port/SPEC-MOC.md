...
# Consumed by speckit-scaffold-spec via token substitution. Token values were
# substituted during scaffold.
#
...
#     relative link target from this value and resolves it. From specs/<branch-name>/
...
spec_id: "XPLAT-005"         # e.g., PRSG-002 - namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# XPLAT-005 - Map of Content
...
- [contracts/read-only-helper-request.schema.json](contracts/read-only-helper-request.schema.json)
