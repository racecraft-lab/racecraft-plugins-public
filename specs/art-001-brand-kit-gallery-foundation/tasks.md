...
- [ ] T001 [P] Record the pre-change baseline by running `python3 tests/speckit-pro/run-all.py` from the repository root and noting the result in the PR working notes
- [ ] T002 [P] Install the docs-site dependencies once for this worktree with `pnpm --dir docs-site install --frozen-lockfile`, required before the `docs-site/` reference regeneration in T032
