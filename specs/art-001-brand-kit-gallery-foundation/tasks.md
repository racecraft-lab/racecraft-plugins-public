...
`tests/speckit-pro/unit/test-artifact-gallery.py` — implementing all 77 checks in
...
- The gallery ships **zero** artifacts. Roughly half the 77 checks are vacuous
