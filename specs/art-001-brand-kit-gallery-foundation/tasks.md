...
`tests/speckit-pro/unit/test-artifact-gallery.py` — implementing all 75 checks in
...
- The gallery ships **zero** artifacts. Roughly half the 75 checks are vacuous
