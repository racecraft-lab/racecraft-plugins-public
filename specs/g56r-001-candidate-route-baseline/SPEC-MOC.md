...
# as workflow-template.md. Every template token is resolved in this file.
#
...
spec_id: "G56R-001"         # e.g., PRSG-002 — namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# G56R-001 — Map of Content
...
- [contracts/combined-pr-reviewability-exception.md](contracts/combined-pr-reviewability-exception.md)
...
- [check-artifacts.py](check-artifacts.py)
