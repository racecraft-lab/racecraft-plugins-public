...
Completes the candidate-route research baseline and makes SpecKit Pro autopilot create and verify the intended pull request before reporting completion in both Claude Code and Codex.
<!-- speckit-pro-editable:summary:end -->

## What Changed

<!-- speckit-pro-editable:what_changed:start -->
- Added a twelve-agent research baseline, machine-readable manifest, offline validator, focused regression tests, task audit, and terminal handoff.
- Authenticated generated pull-request content against an immutable source commit, added secure atomic output handling, and rejected stale or tampered review packets.
- Aligned Claude Code and Codex on the same required completion steps, refreshed installable payloads, recorded external validation, and ensured CI has the history needed to validate frozen revisions.
<!-- speckit-pro-editable:what_changed:end -->

## Why It Matters

<!-- speckit-pro-editable:why_it_matters:start -->
Autopilot now finishes only after the intended pull request exists and matches the verified source, while stale or tampered review material cannot authorize a GitHub update.
...
- Final uninterrupted default deterministic suite passed Layer 1, Layer 4, and Layer 5. Source: tests/speckit-pro/run-all.py. Result: 2834/2834 passed.
...
- Source-bound packet output and secure atomic mutation regressions passed. Source: tests/speckit-pro/unit/test-speckit-pro-mutation-helpers.py. Result: 37/37 passed.
- Packet freshness and read-only validation regressions passed. Source: tests/speckit-pro/unit/test-speckit-pro-read-only-helpers.py. Result: 49/49 passed.
- Spec-index secure-write prerequisite and committed-state regressions passed. Source: tests/speckit-pro/unit/test-generate-spec-index.py. Result: 12/12 passed.
- Claude Code and Codex Post lifecycle and packet authorization contracts passed. Source: tests/speckit-pro/unit/test-post-implementation-reference.py. Result: 48/48 passed.
...
- Changed files:
  ...
  - `tests/speckit-pro/parity/bash-to-python/test-post-implementation-reference-baseline.txt`
  ...
  - `tests/speckit-pro/unit/test-generate-spec-index.py`
  - `tests/speckit-pro/unit/test-post-implementation-reference.py`
