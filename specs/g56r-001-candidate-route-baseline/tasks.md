...
- [x] T004 Add the project-input inventory outline for PRD, roadmap, active Codex TOMLs, Claude parity files, fixture inputs, payload/cache references, and generated artifacts in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T005 Add the traceability matrix skeleton and authority-class review rules to `docs/ai/research/codex-agent-route-candidates.md`
- [x] T006 Add the completeness matrix skeleton for 9 source records, 12 role contracts, 12 fixture records, 3 current fixtures, 9 missing fixtures, and 0 unsupported admitted seed candidates to `docs/ai/research/codex-agent-route-candidates.md`
- [x] T007 Add the G56R-002 capability-question and no-go decision skeleton to `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T010 [US1] Record source family, page or surface, direct URL, retrieval date, documented facts, supported surfaces, and invalidation triggers for each source in `docs/ai/research/codex-agent-route-candidates.md`
- [x] T011 [US1] Evaluate the roadmap seed models against official documentation and record documented, deprecated, withdrawn, unsupported, or undocumented status in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T015 [US2] Compute instruction and full-file SHA256 hashes for each role source and record hash source details in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T021 [US3] Create source-bound `CandidateRouteRecord` entries only for model and effort tuples supported by the frozen official-source ledger and role contracts in `docs/ai/research/codex-agent-route-candidates.md`
- [x] T022 [US3] Record rejected, deprecated, withdrawn, undocumented, or blocked seed candidates and their unsupported facts in `docs/ai/research/codex-agent-route-candidates.md`
- [x] T023 [US3] Add per-surface effort/default records, required capabilities, lifecycle fields, capability questions, and invalidation rules to each candidate route in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T029 [US4] Add the strict go/no-go matrix with `GO` only for complete G56R-002 capability discovery and `NO-GO` for executable candidate set, qualification, installation, resolver behavior, and fallback policy in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T031 Map every functional requirement and success criterion to report sections and verification evidence in `docs/ai/research/codex-agent-route-candidates.md`
...
- [x] T033 Run exact count review for 9 source records, 12 role contracts, 12 fixture records, 3 current fixtures, 9 missing fixtures, and 0 unsupported admitted seed candidates in `docs/ai/research/codex-agent-route-candidates.md`
