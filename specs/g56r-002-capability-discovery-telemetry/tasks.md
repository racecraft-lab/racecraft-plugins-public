...
- [x] T039 [US1] [FR-001] [FR-008] Validate the final PR title and changed-file contract through the release-readiness gate invoked by `.github/workflows/pr-checks.yml` using a lowercase conventional scope; Acceptance: `<type>(<lowercase-scope>): <plain English description>` passes with the exact planned changed-file set.
