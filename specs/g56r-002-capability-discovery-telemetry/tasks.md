...
now 2,065 source lines (1,855 nonblank, non-comment) after independent-review
...
- [ ] T025 [US2] [FR-005] [FR-007] Run the US2 independent test in `tests/speckit-pro/unit/test-codex-capability-contract.py` and inspect the diff for configured-as-effective, missing-reroute-as-none, service-as-resolver, or fabricated null values; Acceptance: focused tests pass and none of the four prohibited patterns exists.
