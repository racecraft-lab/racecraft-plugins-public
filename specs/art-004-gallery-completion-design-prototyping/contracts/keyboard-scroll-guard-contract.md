...
2. Focus the declared horizontal region by keyboard.
3. Verify the accessible name remains exposed.
4. Send the horizontal arrow key supported by the browser.
5. Confirm horizontal scroll position changes without pointer input.
