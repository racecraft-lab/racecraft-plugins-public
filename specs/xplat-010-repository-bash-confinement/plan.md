...
├── speckit-pro/speckit_pro_runner/      # SHIPPED runner (byte changes → regen ritual; PRs 2,10,13)
│   ├── gates/
...
│   └── speckit-pro-runner.manifest.json  # PRs 2/10/13: sha256 rows; PR 13: plugin_version fix
...
(`speckit-pro/speckit_pro_runner/`) changes only in PRs 2/10/13 and each such change runs the
