...
# Consumed by speckit-scaffold-spec via token substitution. Generated for DOC-002.
#
...
spec_id: "DOC-002"           # e.g., PRSG-002 - namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# DOC-002 - Map of Content
