...
This PR covers one reviewer-ready slice: Block invalid PR packets before creation.
...
- Implements the slice named in the title: Block invalid PR packets before creation.
...
1. Confirm the title and Summary describe the slice you expected: Block invalid PR packets before creation.
