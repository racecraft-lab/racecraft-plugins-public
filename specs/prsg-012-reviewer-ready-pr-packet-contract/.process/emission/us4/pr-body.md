...
This PR covers one reviewer-ready slice: Protect editable PR body prose.
...
- Implements the slice named in the title: Protect editable PR body prose.
...
1. Confirm the title and Summary describe the slice you expected: Protect editable PR body prose.
