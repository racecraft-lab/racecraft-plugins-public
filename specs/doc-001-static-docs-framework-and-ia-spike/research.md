...
| Repo-native fallback | Reject | Lowest maintenance, but it does not satisfy rich component interactivity, site search, route-level IA, or versioning without adding separate tooling. |
...
No hard blocker was found for Docusaurus. Search remains the main documented tradeoff.
