...
- `git diff --name-only origin/main...HEAD` listed 23 files.
- `git diff --name-only origin/doc-001-static-docs-framework-and-ia-spike...HEAD` listed 17 DOC-001 post-scaffold files.
...
- Final reviewability backstop proceeded with `outcome=marker_split`.
