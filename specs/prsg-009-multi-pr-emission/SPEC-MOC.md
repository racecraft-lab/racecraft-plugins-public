...
spec_id: "PRSG-009"          # e.g., PRSG-002 - namespace-matches the containing directory
structureVersion: 1          # keep in sync with the lint scripts' hardcoded literal
---

# PRSG-009 - Map of Content
...
- [contracts/multi-pr-emission-state.schema.json](contracts/multi-pr-emission-state.schema.json)
