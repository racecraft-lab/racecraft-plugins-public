...
- [x] T049 [P] [US3] Fetch upstream `01-exploration-code-approaches.html` read-only into the session scratchpad. Acceptance: read-only network access, bytes stay in the scratchpad, nothing staged.
