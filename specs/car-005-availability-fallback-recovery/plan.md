...
unit test, 1 manifest entry, 1 regenerated docs page. 2 user stories, 44
...
of 44 distinct FR identifiers — the spec carries eleven lettered
sub-requirements such as FR-012a and FR-033d — yields 1,110. Both exceed the
...
| `unit/test-route-fallback-simulation.py` | create — resolution semantics, replay byte-identity, roadmap parity, inline enum-closure negative test | append the US2 test functions |
...
├── spec.md              # Input (clarified: 44 FRs, 0 markers)
