...
- The manifest declares version `2.33.0`. Source refs: `dist/codex/speckit-pro/.codex-plugin/plugin.json`.
...
- The manifest declares version `2.33.0`. Source refs: `speckit-pro/.codex-plugin/plugin.json`.
