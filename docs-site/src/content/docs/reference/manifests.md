...
- The manifest declares version `0.12.12.dev0`. Source refs: `.specify/integrations/claude.manifest.json`.
...
- The manifest declares version `0.12.12.dev0`. Source refs: `.specify/integrations/speckit.manifest.json`.
...
- The manifest declares version `2.19.0`. Source refs: `dist/claude/speckit-pro/.claude-plugin/plugin.json`.
...
- The manifest declares version `2.19.0`. Source refs: `dist/codex/speckit-pro/.codex-plugin/plugin.json`.
...
- The manifest declares version `2.19.0`. Source refs: `speckit-pro/.claude-plugin/plugin.json`.
...
- The manifest declares version `2.19.0`. Source refs: `speckit-pro/.codex-plugin/plugin.json`.
