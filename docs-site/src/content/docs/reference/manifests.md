...
- The manifest declares version `2.36.3`. Source refs: `dist/codex/speckit-pro/.codex-plugin/plugin.json`.
...
- The manifest declares version `2.36.3`. Source refs: `speckit-pro/.codex-plugin/plugin.json`.
