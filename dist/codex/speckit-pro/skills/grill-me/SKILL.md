...
```text
bash "../speckit-coach/scripts/estimate-spec-size.sh" \
...
- **`../speckit-coach/references/slicing-heuristics.md`** — the
  ...
  branch; invoked via `../speckit-coach/scripts/estimate-spec-size.sh`).
