...
| Explain autonomous execution, consensus, remediation, review loops, or configuration | [Autopilot guide](references/autopilot-guide.md). Route execution to `$speckit-autopilot`. |
