...
- Read specific known files (constitution, technical roadmap, CLAUDE.md)
- Find all spec directories and their artifacts
- Search across specs for specific decisions or patterns
