...
source "$HERE/../lib/moc-id-normalize.sh"

# The single shared generator under test (sibling of reviewability-gate.sh).
# layer4-scripts -> tests -> speckit-pro.
GEN="$HERE/../../skills/speckit-autopilot/scripts/generate-spec-index.sh"
