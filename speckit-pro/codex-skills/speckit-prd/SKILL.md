...
[capability-discovery](../../skills/speckit-autopilot/references/capability-discovery.md)
and [grounding](../../skills/speckit-autopilot/references/grounding.md) contracts.
...
1. Read the [shared PRD authoring protocol](../../skills/speckit-prd/references/prd-authoring-protocol.md).
...
4. Use the shared [PRD template](../../skills/speckit-coach/templates/prd-template.md).
...
5. Use the shared
   ...
   and [slicing heuristics](../../skills/speckit-coach/references/slicing-heuristics.md).
