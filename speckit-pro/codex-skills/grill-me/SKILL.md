...
2. Read the [shared interview protocol](../../skills/grill-me/references/interview-protocol.md).
...
5. Stop at natural convergence, when the user ends the interview, or at the
   ...
   [Design Concept output contract](../../skills/grill-me/references/output-formats.md)
