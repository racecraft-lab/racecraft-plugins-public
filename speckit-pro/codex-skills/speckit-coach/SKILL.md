...
| **Plugin Usage** | |
| "install codex agents", "subagents missing", "repair codex install", "refresh codex agents" | Guide to `$speckit-pro:install` — copy the bundled Codex TOML subagents into `~/.codex/agents/`, verify the install, then restart Codex |
