...
| **Plugin Usage** | |
| "run autopilot", "execute workflow", "autonomous" | Guide to `$speckit-autopilot` — prerequisites, workflow file setup, `--dangerously-skip-permissions`. See [autopilot guide](../../skills/speckit-coach/references/autopilot-guide.md) |
| "check status", "where am I", "workflow progress", "what's next", "roadmap", "project health" | Guide to `$speckit-status` for technical roadmap progress (completed, ready, blocked specs), or `$speckit-doctor` for project health diagnostics |
| "configure autopilot", "settings", "consensus mode" | Guide to `.claude/speckit-pro.local.md` settings — consensus mode, auto-commit, gate failure behavior. See [autopilot guide](../../skills/speckit-coach/references/autopilot-guide.md) |
...
| "doctor", "project diagnostics", "health check" | Run `$speckit-doctor` for full project diagnostic (structure, agents, features, scripts, extensions, git). See [presets & extensions guide](../../skills/speckit-coach/references/presets-extensions-guide.md) |
...
| "setup spec", "create worktree", "prepare for autopilot" | Guide to `$speckit-setup` — creates worktree, branch, workflow file |
...
- [Technical Roadmap Template](../../skills/speckit-coach/templates/technical-roadmap-template.md) — Multi-spec project decomposition
