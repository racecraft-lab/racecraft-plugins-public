---
name: speckit-coach
description: "SpecKit SDD coach. Invoke to explain, guide, walk through, or help troubleshoot Spec-Driven Development: getting started with SDD from scratch, which checklist domains to pick (api, security, observability, data-integrity, resilience), a failing simplicity gate or gate-validator rejecting acceptance criteria, writing testable acceptance criteria, the consensus protocol and phase gates, the difference between specify plan and specify tasks, what speckit commands do and when to use them, how presets like tdd-mandate change the workflow, where grill-me or clarify fit in the SDD process, decomposing a large feature into multiple specs or creating a technical roadmap, repairing or hardening a speckit-pro project, and browsing, installing, or removing SpecKit extensions, presets, hooks, and catalog entries (verify, doctor, archive, retrospective, jira). Not for running autopilot, conducting the grill-me interview, or unrelated tasks (linting, MCP tools, PR review, git status, build errors)."
---
