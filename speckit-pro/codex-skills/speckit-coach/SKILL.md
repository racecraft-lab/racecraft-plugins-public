...
Use [the knowledge lifecycle reference](../../skills/speckit-coach/references/knowledge-lifecycle.md)
...
| "roadmap map", "home note", "Map of Content", "roadmap-MOC", "navigation", "can I edit the MOC", "cap epics" | Explain the canonical OKF roadmap concept and generated MOC compatibility view from [roadmap-MOC guide](../../skills/speckit-coach/references/roadmap-moc-guide.md). Curated grouping lives in reviewed knowledge; all indexes and legacy MOC zones are generated through knowledge plan/apply. The about-ten-epic guardrail remains advisory. |
...
- [Knowledge Lifecycle](../../skills/speckit-coach/references/knowledge-lifecycle.md) — OKF bundle, trust, runner operations, receipts, candidates, promotion, and archive rules
- [Roadmap-MOC Guide](../../skills/speckit-coach/references/roadmap-moc-guide.md) — Canonical OKF roadmap maps and generated legacy MOC compatibility views
