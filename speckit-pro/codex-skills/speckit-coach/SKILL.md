...
When the developer asks about any SpecKit command, provide coaching from [the command guide](../../skills/speckit-coach/references/command-guide.md):

| User says... | Action |
|---|---|
| **Getting Started & Learning** | |
| "I'm new", "getting started", "how do I start", "first time" | Walk through setup and first workflow from [getting started guide](../../skills/speckit-coach/references/getting-started.md) |
| "what is SDD", "spec-driven development", "methodology" | Explain SDD from [methodology reference](../../skills/speckit-coach/references/sdd-methodology.md) |
...
| "roadmap map", "home note", "Map of Content", "roadmap-MOC", "navigation", "how is the home note structured", "curated vs generated zone", "two-zone", "can I edit the INDEX", "cap epics" | Explain the roadmap-MOC home note's two-zone structure from [roadmap-MOC guide](../../skills/speckit-coach/references/roadmap-moc-guide.md) — the curated epics zone is hand-authored/editable, the GENERATED INDEX zone is machine-regenerated by runner operation `generate-spec-index-write` and never hand-edited, and the cap-epics-below-~10 guardrail is advisory (warns, never blocks) |
...
| "configure autopilot", "settings", "consensus mode" | Guide to `.claude/speckit-pro.local.md` settings (project-relative path, works on both Claude Code and Codex) — consensus mode, auto-commit, gate failure behavior. See [autopilot guide](../../skills/speckit-coach/references/autopilot-guide.md) |
| "how does consensus work", "clarify automation" | Explain the 3-agent consensus protocol — codebase-analyst, spec-context-analyst, domain-researcher. See [autopilot guide](../../skills/speckit-coach/references/autopilot-guide.md) |
| "gap remediation", "checklist automation" | Explain checklist gap remediation loop — consensus agents propose fixes, auto-edit, re-verify. See [autopilot guide](../../skills/speckit-coach/references/autopilot-guide.md) |
...
| "something went wrong", "this isn't working", "bad output" | Identify the problem phase and guide recovery from [getting started](../../skills/speckit-coach/references/getting-started.md) — see "Troubleshooting & Recovery" |
...
| **Quality Evaluation** | |
| "is my spec good", "evaluate", "review quality" | Walk through quality signals from [getting started](../../skills/speckit-coach/references/getting-started.md) — see "How to Evaluate Quality at Each Gate" |
...
| **Team Workflow** | |
| "team", "who reviews", "PR workflow", "collaboration" | Guide team workflow from [getting started](../../skills/speckit-coach/references/getting-started.md) — see "Working with a Team" |
...
1. Copy the [workflow template](../../skills/speckit-coach/templates/workflow-template.md) to `docs/ai/specs/SPEC-<ID>-workflow.md`
...
See [Checklist Domains Guide](../../skills/speckit-coach/references/checklist-domains-guide.md) for the full signal extraction algorithm and enriched prompt patterns.
...
The autopilot reads a populated workflow file and executes all 7 phases autonomously with programmatic gate validation, multi-agent consensus resolution, and auto-commits. See the [Autopilot Guide](../../skills/speckit-coach/references/autopilot-guide.md) for full documentation.
...
- [Getting Started](../../skills/speckit-coach/references/getting-started.md) — First-time setup, walkthrough, troubleshooting, quality evaluation
- [SDD Methodology](../../skills/speckit-coach/references/sdd-methodology.md) — Full philosophy, principles, and patterns
- [Command Guide](../../skills/speckit-coach/references/command-guide.md) — Per-command coaching with gates and pitfalls
- [Constitution Guide](../../skills/speckit-coach/references/constitution-guide.md) — Designing effective project constitutions
- [Checklist Domains Guide](../../skills/speckit-coach/references/checklist-domains-guide.md) — Identifying and creating domain checklists
- [Best Practices](../../skills/speckit-coach/references/best-practices.md) — Lessons learned, anti-patterns, tips
- [Presets & Extensions Guide](../../skills/speckit-coach/references/presets-extensions-guide.md) — Presets, extensions, hooks, catalogs, custom presets
- [Autopilot Guide](../../skills/speckit-coach/references/autopilot-guide.md) — Autonomous execution, consensus protocol, configuration
- [Roadmap-MOC Guide](../../skills/speckit-coach/references/roadmap-moc-guide.md) — The home note's curated-vs-generated two-zone structure and the advisory epic cap
- [PRD Template](../../skills/speckit-coach/templates/prd-template.md) — Lean, universal PRD; author it with `$speckit-prd`
- [Technical Roadmap Template](../../skills/speckit-coach/templates/technical-roadmap-template.md) — Multi-spec project decomposition (SPEC catalog derived from the PRD)
- [Workflow Template](../../skills/speckit-coach/templates/workflow-template.md) — Per-spec 7-phase tracking
