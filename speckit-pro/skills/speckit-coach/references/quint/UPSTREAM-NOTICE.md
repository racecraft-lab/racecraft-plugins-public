...
- Project: Quint LLM Kit
- Original author and copyright holder: Informal Systems Inc.
- Upstream repository: `quint-co/quint-llm-kit`
- Pinned upstream commit: `cc75369f741af7d490936f82002c2d28e3b3d78d`
- License: Apache-2.0 (SPDX identifier `Apache-2.0`)
- Upstream source paths:
  - `quint-llm-kit-plugin/skills/quint-lang`
  - `quint-llm-kit-plugin/skills/quint-modeling`
- Canonical license text:
  `https://github.com/quint-co/quint-llm-kit/blob/cc75369f741af7d490936f82002c2d28e3b3d78d/LICENSE`

Neither skill tree is an active skill inside SpecKit Pro. They are authoring
references only, and their presence never enrolls a feature in formal checking.

## License text, reproduced verbatim

Reproduced byte for byte from the upstream repository at the pinned commit. Do
not edit, reword, or reformat anything between the fences below.
...
```text
   ...
   Copyright 2026 Informal Systems Inc.
