...
if [ -f "$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/codex-evals/${SKILL}-evals.json" ]; then
  EVAL_FILE="$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/codex-evals/${SKILL}-evals.json"
elif [ -f "$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/evals/${SKILL}-evals.json" ]; then
  EVAL_FILE="$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/evals/${SKILL}-evals.json"
else
  EVAL_FILE=""
fi
...
if [ -z "$EVAL_FILE" ]; then
  ...
  find "$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/codex-evals" "$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/evals" \
