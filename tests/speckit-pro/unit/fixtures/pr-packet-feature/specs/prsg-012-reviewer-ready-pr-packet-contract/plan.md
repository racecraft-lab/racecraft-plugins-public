...
- NEW tests/speckit-pro/unit/test-validate-pr-packet.sh
- MODIFIED tests/speckit-pro/unit/test-generate-pr-body.sh
- MODIFIED tests/speckit-pro/unit/test-multi-pr-emission.sh
- NEW tests/speckit-pro/unit/fixtures/pr-packet/valid-single.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/valid-split.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/invalid-title-token.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/invalid-missing-evidence.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/invalid-protected-edit.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/invalid-missing-packet.args
- NEW tests/speckit-pro/unit/fixtures/pr-packet/invalid-malformed-json.json
- NEW tests/speckit-pro/unit/fixtures/pr-packet/split-partial-failure-state.json
