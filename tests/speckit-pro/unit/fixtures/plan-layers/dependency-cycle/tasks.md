...
- [ ] T001 Define the planner contract in speckit-pro/skills/speckit-autopilot/SKILL.md
...
- [ ] T003 [US2] Parse the US2 increment in tests/speckit-pro/unit/test-plan-layers.sh

## Phase 4: User Story 3 - Validate Longer Cycles (Priority: P2)

- [ ] T004 [US3] Parse the US3 increment in tests/speckit-pro/unit/test-plan-layers.sh
