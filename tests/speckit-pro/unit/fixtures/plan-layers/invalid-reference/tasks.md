...
- [ ] T003 [US1] Reference a missing test tests/speckit-pro/unit/no-such-plan-layers-test.sh

## Phase 3: Polish and Validation

- [ ] T004 Validate warnings with tests/speckit-pro/unit/test-plan-layers.sh
