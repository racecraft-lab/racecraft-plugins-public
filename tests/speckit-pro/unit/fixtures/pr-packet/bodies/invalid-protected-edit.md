<!-- speckit-pro-review-packet-source: tests/speckit-pro/unit/fixtures/pr-packet/invalid-protected-edit.json -->
...
- `jq empty tests/speckit-pro/unit/fixtures/pr-packet/valid-single.json`
