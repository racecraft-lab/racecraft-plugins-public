...
- NEW tests/speckit-pro/unit/test-atomicity-route.sh
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/additive-multi-seam/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/single-additive-seam/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/hard-atomic-rename/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/hard-atomic-version-pin/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/hard-atomic-destructive-migration/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/hard-atomic-mutual-exclusion/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/hard-atomic-out-of-tree-contract/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/concurrency/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/modify-heavy/tasks.md
- NEW tests/speckit-pro/unit/fixtures/atomicity-route/out-of-scope-empty/.gitkeep
...
|-----------|-------|--------|
| I. Plugin Structure Compliance | New script lives under `speckit-pro/skills/speckit-autopilot/scripts/`; test lives in repo-root `tests/speckit-pro/unit/` (NOT inside the plugin dir, per the payload guard). No new plugin, command, agent, or hook. | PASS |
