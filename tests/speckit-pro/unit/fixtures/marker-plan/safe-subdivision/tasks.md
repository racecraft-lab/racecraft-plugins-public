...
- [ ] T003 [US1] Test first marker cluster in tests/speckit-pro/unit/test-plan-layers.sh
- [ ] T004 [US1] Implement second marker cluster in speckit-pro/skills/speckit-autopilot/scripts/count-markers.sh
- [ ] T005 [US1] Test second marker cluster in tests/speckit-pro/unit/test-reviewability-gate.sh
