...
- [ ] T002 Add marker planner tests in tests/speckit-pro/unit/test-plan-layers.sh

## Phase 2: User Story 1 - Build Marker Plan (Priority: P1)

- [ ] T003 [P] [US1] Build marker mode in speckit-pro/skills/speckit-autopilot/scripts/plan-layers.sh and tests/speckit-pro/unit/test-plan-layers.sh
...
- [ ] T007 Run tests/speckit-pro/unit/test-plan-layers.sh and update speckit-pro/skills/speckit-autopilot/scripts/plan-layers.sh
