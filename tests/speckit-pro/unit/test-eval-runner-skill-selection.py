...
class EvalRunnerSkillSelectionTests(unittest.TestCase):
    ...
    def test_codex_autopilot_worktree_handoff_contract(self) -> None:
        ...
        self.assertIn("registration and containment checks", normalized_prerequisites)
        ...
        self.assertIn("explicitly supplied the absolute workflow path", prerequisites)
        self.assertIn("real sandbox denial", prerequisites)
