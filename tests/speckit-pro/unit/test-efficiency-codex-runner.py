...
Port target for ``test-efficiency-codex-runner.sh`` (XPLAT-010 PR9 T084 half).
...
BASELINE = TESTS_ROOT / "parity" / "bash-to-python" / "test-efficiency-codex-runner-baseline.txt"
...
def main() -> int:
    ...
    return run_counted(suite, label="test-efficiency-codex-runner")
