...
BASELINE = TESTS_ROOT / "parity" / "bash-to-python" / "test-efficiency-runner-portability-baseline.txt"
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_counted(suite, label="test-efficiency-runner-portability"))
