...
def main(argv=None) -> int:
    ...
    parser.add_argument("--carry-forward", type=Path, help="Explicit versioned case-level evidence carry-forward request")
    ...
    try:
        ...
        request = CampaignRequest(manifest, read_json(args.approval), args.launch_budget,
            ...
            read_json(args.carry_forward) if args.carry_forward else None)
