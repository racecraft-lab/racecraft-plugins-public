...
Synthetic workflow used by Layer 7 parity fixture 03. The fixture records the
operator-facing SPEC-910 behavior that must stay equivalent across Claude Code
and Codex surfaces.

| Field | Value |
|-------|-------|
| Spec Directory | specs/parity-03-reviewability-backstop-parent-child-routing |
| Branch | parity-03-reviewability-backstop-parent-child-routing |
