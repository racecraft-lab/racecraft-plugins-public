...
Layer 7 live mode compares the same workflow after Path A and Path B execution.
...
```bash
python3 tests/speckit-pro/layer7-parity/run-parity-fixtures.py --dry-run --fixture 02-repository-migration-guidance
```

Live mode is optional and token-costly, consistent with Layer 7.
