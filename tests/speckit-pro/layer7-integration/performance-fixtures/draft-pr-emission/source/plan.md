...
the strict-mode blocked-stop contract. They end it at create-or-refresh, after
the boundary commit and the push, so the durably recorded discrepancy still
reaches version history. No step of the emission sequence is
