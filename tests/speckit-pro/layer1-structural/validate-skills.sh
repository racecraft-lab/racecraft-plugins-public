...
SKILLS=(grill-me speckit-archive-cleanup speckit-autopilot speckit-coach speckit-install speckit-upgrade speckit-scaffold-spec speckit-status speckit-resolve-pr speckit-prd)
