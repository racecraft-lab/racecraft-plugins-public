...
FUNCTIONAL_SCRIPT="$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/run-functional-evals.sh"
TRIGGER_SCRIPT="$PLUGIN_ROOT/../tests/speckit-pro/layer2-trigger/run-trigger-evals.sh"
CODEX_FUNCTIONAL_SCRIPT="$PLUGIN_ROOT/../tests/speckit-pro/layer3-functional/run-functional-evals-codex.sh"
CODEX_TRIGGER_SCRIPT="$PLUGIN_ROOT/../tests/speckit-pro/layer2-trigger/run-trigger-evals-codex.sh"
...
for codex_only_skill in speckit-scaffold-spec speckit-status speckit-resolve-pr install; do
  ...
  set_test "Codex trigger runner uses codex skill for ${codex_only_skill}"
  output=$(bash "$CODEX_TRIGGER_SCRIPT" "$codex_only_skill")
  assert_contains "$output" "Skill path: $PLUGIN_ROOT/codex-skills/${codex_only_skill}"
done
