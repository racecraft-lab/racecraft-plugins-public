...
- [ ] T002 Deduplicate repeated references in specs/prsg-008-layer-planner/contracts/plan-layers.output.md and ./specs/prsg-008-layer-planner/contracts/plan-layers.output.md
