...
BASELINE = TESTS_ROOT / "parity" / "xplat-010" / "test-layer2-signal-restoration-baseline.txt"
...
if __name__ == "__main__":
    ...
    raise SystemExit(run_counted(suite, label="test-layer2-signal-restoration"))
