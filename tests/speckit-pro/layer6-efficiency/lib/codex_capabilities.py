...
def _load_runtime_dependencies() -> dict[str, object]:
    dependency_names = (
        ...
        "codex_capability_append_only",
        "codex_capability_private",
        "codex_capability_capture",
        "codex_capability_retention_records",
        "codex_capability_publication_records",
        "codex_capability_retention_recovery",
        "codex_capability_retention_authority",
...
_EXPORTS_BY_MODULE = (
    ...
    (
        ...
        (
            ...
            "PRIVATE_REFRESH_MAX_BYTES", "PRIVATE_TEMPORARY_PREFIX",
