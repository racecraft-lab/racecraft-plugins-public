...
status: "Active; HRNS-001 taxonomy implemented, post-implementation gates in progress"
rank:
...
- [HRNS-001](../../../specs/hrns-001-harness-surface-inventory-gap-taxonomy/SPEC-MOC.md) · Implemented; post gates in progress
<!-- GENERATED:INDEX:END -->
