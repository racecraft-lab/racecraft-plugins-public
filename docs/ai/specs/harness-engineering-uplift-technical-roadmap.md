...
|---|---|---|---|---|
| HRNS-001 | Harness Surface Inventory and Gap Taxonomy | In Progress | [.process/HRNS-001-workflow.md](.process/HRNS-001-workflow.md) | Run `$speckit-autopilot` from the dedicated worktree |
