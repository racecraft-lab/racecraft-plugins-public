...
| Implement | `/speckit-implement` | In Progress | Foundation shell baseline complete; starting landing-page tasks T008-T012 |
...
| Landing page | T008-T012 | In Progress | Next group creates the thin actionable landing page and platform-choice links |
| Route shell | Pending | Pending | Pending |
