...
status: "XPLAT-001 through XPLAT-008 complete/archived; XPLAT-009 ready; XPLAT-010 blocked until plugin Bash cleanup completes"
rank:
...
- XPLAT-009 Plugin Source and Payload Bash Eradication (ready; next scaffold
  target; removes remaining plugin source scripts and active Bash instructions)
