...
status: "XPLAT-001 through XPLAT-008 complete/archived; XPLAT-009 in progress; XPLAT-010 blocked until plugin Bash cleanup completes"
rank:
...
- XPLAT-009 Plugin Source and Payload Bash Eradication (in progress on
  `codex/xplat-009-plugin-source-and-payload-bash-eradication`; removes
  remaining plugin source scripts and active Bash instructions)
- XPLAT-010 Repository Bash Confinement and CI Dispatch Guard (blocked until
  XPLAT-009 completes; confines repo Bash to GitHub CI/CD workflow dispatch
  glue only, adds Linux AMD64/ARM64 containerized preflight, and records Windows
  x64/ARM64 direct-runner smoke without treating containers as native UAT)

<!-- GENERATED:INDEX:START (do not edit; regenerated by generate-spec-index.sh) -->
- [XPLAT-009](../../../specs/xplat-009-plugin-source-and-payload-bash-eradication/SPEC-MOC.md) ·
<!-- GENERATED:INDEX:END -->
