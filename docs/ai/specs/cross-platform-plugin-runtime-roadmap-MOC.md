...
status: "XPLAT-001 through XPLAT-007 complete/archived; XPLAT-008 in progress"
rank:
...
- XPLAT-008 Claude/Codex Cutover and Universal Install Release Gate (in progress
  on `codex/xplat-008-claude-codex-cutover-universal-install-release-gate`;
  workflow:
  `docs/ai/specs/.process/XPLAT-008-workflow.md`)

<!-- GENERATED:INDEX:START (do not edit; regenerated by generate-spec-index.sh) -->
- [XPLAT-008](../../../specs/xplat-008-claude-codex-cutover-universal-install-release-gate/SPEC-MOC.md) ·
<!-- GENERATED:INDEX:END -->
