...
- [TACD-004 Verification Coverage](tool-agnostic-capability-discovery-technical-roadmap.md#tacd-004-verification-coverage) - ready to scaffold

<!-- GENERATED:INDEX:START (do not edit; regenerated by generate-spec-index.sh) -->
- [DOC-010](../../../specs/doc-010-search-accessibility-deep-links-docs-validation/SPEC-MOC.md) · in-progress
<!-- GENERATED:INDEX:END -->
