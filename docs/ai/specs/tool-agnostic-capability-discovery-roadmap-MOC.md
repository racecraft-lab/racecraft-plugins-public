...
- [TACD-004 Verification Coverage](tool-agnostic-capability-discovery-technical-roadmap.md#tacd-004-verification-coverage) - in progress on `tacd-004-verification-coverage` (also bundles the Claude payload-build fix)

<!-- GENERATED:INDEX:START (do not edit; regenerated by generate-spec-index.sh) -->
- [TACD-004](../../../specs/tacd-004-verification-coverage/SPEC-MOC.md) · 
<!-- GENERATED:INDEX:END -->
