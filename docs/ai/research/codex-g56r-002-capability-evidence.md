...
and temporary-name removal. Reserved private temporary names block normal
operations and read-only verification. Locked cleanup removes them and fsyncs
their parents, accepting only the recoverable one-temporary/one-final-link crash
window; external or additional hard links remain invalid.
