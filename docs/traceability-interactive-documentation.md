...
|---|---|---|---|---|---|---|---|---|
| DOC-FR-001 | Static docs framework and IA spike | DOC-001 | AC-1.1, AC-1.2, AC-1.3, AC-1.4 | Maintainer | Docusaurus docs, Diataxis, repo absence of site config | Research artifact review; no product code changes | Pending | Spike before stack commitment. |
| DOC-FR-002 | Unified landing page and IA shell | DOC-002 | AC-2.1, AC-2.2, AC-2.3, AC-2.4, AC-2.5 | First-time user | README, `speckit-pro/README.md`, Diataxis | Static site build; nav inspection; local link check | Pending | Depends on DOC-001. |
...
| DOC-FR-004 | Codex marketplace installation path | DOC-004 | AC-4.1, AC-4.2, AC-4.3, AC-4.4, AC-4.5, AC-4.6 | Codex user | OpenAI Codex plugin/skills/subagents/security docs; `.agents/plugins/marketplace.json`; `.codex-plugin/plugin.json` | Link check; command review; source file existence check | Pending | Must validate personal marketplace path wording. |
